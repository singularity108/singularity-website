import{c as a,j as e,R as o}from"./Layout-CwGfZF_V.js";import{M as r}from"./MarkdownPage-B0SSDaNM.js";import"./Footer-CvzC9H07.js";const s=`# Política de Garantía (general)
...
**✔ Garantía por verificación inmediata al momento de la entrega:** En el caso en el que sea altamente probable que tu pedido haya sido maltratado por un evidente mal estado del paquete, estás en tu derecho de tomarte un breve tiempo para verificar tu compra en el mismo momento de la entrega y en caso de que éste tenga daños evidentes puedes rechazar la entrega sin que pagues nada. *Recuerda por favor tomar la evidencia del estado del paquete y del producto para ayudarnos a identificar el caso y poder brindarte la solución más adecuada garantizando las condiciones de la oferta que hayas pedido, ésto no sólo te ayuda a tí sino a futuros clientes.*

**✔ Garantía de compra asegurada:** Adicionalmente al primer punto, si alguno de tus productos llega en mal estado, no funciona o no es el que pediste, contáctanos *tan pronto evidencies la situación* dentro de los primeros tres (3) días desde el momento de la entrega y con gusto haremos toda la gestión de recolección de tu producto para que puedas cambiarlo o solicitar un reembolso. Respetamos tu tiempo y tu dinero y por ello asumimos el proceso y los costos asociados para que no tengas que preocuparte por nada, sólo debes dejar el paquete listo para recoger y estar disponible para la recolección el día acordado.

**✔ Garantía ante desperfectos:** Si tu producto sí es el que pediste y llega en perfecto estado, pero luego presenta fallas por defectos de fabricación dentro de los diez (10) días desde el momento de la entrega, tienes esos 10 días para evidenciarlo y 5 días adicionales a partir de nuestro reconocimiento del caso para devolverlo por tu cuenta. Claro está, esto no aplica si eres el responsable de los daños por uso indebido, descuido del producto u otras situaciones ajenas a nuestro control. Si dichas fallas se presentan en los primeros tres (3) días, quedas cubierto por la *Garantía de compra asegurada*, sin embargo más allá de los primeros tres (3) días serás el responsable de hacer la devolución.

**✔ Garantía ante insatisfacción por la compra:** Si no estás satisfecho con la compra (y el producto sí es el que pediste y está en perfecto estado), puedes contactarnos dentro de los tres (3) días siguientes al momento de la entrega para cambiarlo o solicitar un reembolso. Sin embargo en este caso siempre serás el responsable de devolverlo independientemente de que tan pronto lo evidencies. También ten en cuenta que tendrás que devolver el producto en un plazo no mayor a 10 días después de la entrega para que podamos tramitar tu cambio o reembolso por este motivo. De esta forma, si el producto no es el que esperabas o no te gusta por cualquier motivo, sólo pagas el envío para devolverlo. *En este caso se aplican términos y condiciones adicionales dependiendo del producto.*
...
`;a.createRoot(document.getElementById("root")).render(e.jsx(o.StrictMode,{children:e.jsx(r,{markdown:s})}));
